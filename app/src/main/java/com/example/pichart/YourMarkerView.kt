...
class YourMarkerView(context: Context, layoutResource: Int, private val pieChartDataArray: Array<MainActivity.PieChartData>) : MarkerView(context, layoutResource) {
